...
export default class Product extends Component {
  ...
  plpCartHandler(e) {
    ...
    this.props.cartItemsHandler({
      attributes,
      productId,
      quantity,
      itemFixedPrice: Number(
        this.props.product.prices[this.props.currencySymbol[0]].amount
      ),
      ...
      <Link to={`/product/${this.props.product.id}`}>
        ...
        >
          ...
          <div
            ...
            style={{ display: this.props.product.inStock ? "none" : "block" }}
          >
          ...
          <div
            ...
            style={{ display: this.state.toCart ? "block" : "none" }}
          >
            <div
              className="plp-add-to-cart"
              onClick={(e) => {
                this.plpCartHandler(e);
              }}
            >
